package com.iven.musicplayer_pruszekszymon;
...
import com.iven.musicplayer_pruszekszymon.adapters.AlbumsAdapter;
import com.iven.musicplayer_pruszekszymon.adapters.ArtistsAdapter;
import com.iven.musicplayer_pruszekszymon.adapters.ColorsAdapter;
import com.iven.musicplayer_pruszekszymon.adapters.SongsAdapter;
import com.iven.musicplayer_pruszekszymon.loaders.ArtistProvider;
import com.iven.musicplayer_pruszekszymon.models.Album;
import com.iven.musicplayer_pruszekszymon.models.Artist;
import com.iven.musicplayer_pruszekszymon.models.Song;
import com.iven.musicplayer_pruszekszymon.playback.EqualizerUtils;
import com.iven.musicplayer_pruszekszymon.playback.MusicNotificationManager;
import com.iven.musicplayer_pruszekszymon.playback.MusicService;
import com.iven.musicplayer_pruszekszymon.playback.PlaybackInfoListener;
import com.iven.musicplayer_pruszekszymon.playback.PlayerAdapter;
import com.iven.musicplayer_pruszekszymon.slidinguppanel.SlidingUpPanelLayout;
import com.iven.musicplayer_pruszekszymon.utils.AndroidVersion;
import com.iven.musicplayer_pruszekszymon.utils.PermissionDialog;
import com.iven.musicplayer_pruszekszymon.utils.SettingsUtils;
...
public class MainActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<List<Artist>>, SongsAdapter.SongSelectedListener, ColorsAdapter.AccentChangedListener, AlbumsAdapter.AlbumSelectedListener, ArtistsAdapter.ArtistSelectedListener {
    ...
    public void openGitPage(View v) {
        try {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/szymonpru")));
